...
class DisappearingMessagesPage extends GetView<DisappearingMessagesController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        titleSpacing: 0,
        title: Text('Disappearing Messages'.tr,
          style: TextStyle(
            color: isDarkMode ? Colors.white : AppColors.primary,
            fontSize: 17,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Options
                      ...() {
                        final options = PrivacyConstants.disappearingOptions;
